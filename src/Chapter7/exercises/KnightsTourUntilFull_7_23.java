...
public class KnightsTourUntilFull_7_23 {
    static final int SIZE = 8;
    static final int FULL_TOUR = SIZE * SIZE;
    static final int[] horizontal = {2, 1, -1, -2, -2, -1, 1, 2};
    static final int[] vertical = {-1, -2, -2, -1, 1, 2, 2, 1};

    public static void main(String[] args) {
        int[] frequency = new int[FULL_TOUR + 1];
        ...
        while (true) {
            ...
            if (moveCount == FULL_TOUR) {
                long endTime = System.currentTimeMillis();
                System.out.println("\n✅ Full tour found!");
                System.out.println("Attempts before success: " + attempts);
            ...
            if (attempts % 100000 == 0)
                System.out.println("Still searching... attempts so far: " + attempts);
        }
    }
