package chapter14.examples;// Fig. 14.16: StaticCharMethods2.java
        ...
        switch (choice) {
            case 1: // convert digit to character
                ...
                System.out.printf("Convert digit to character: %s%n",
                        Character.forDigit(digit, radix)); // <- line 28 filled in
                break;
            ...
            case 2: // convert character to digit
                ...
                System.out.printf("Convert character to digit: %s%n",
                        Character.digit(character, radix)); // <- line 35 filled in
                break;
