...
public class RadioButtonFrame extends JFrame {
    ...
    public RadioButtonFrame() {
        ...
        add(boldItalicJRadioButton); // add bold/italic button to JFrame
    ...
    // private inner class for handling radio button events
    private class RadioButtonHandler implements ItemListener {
        private final Font font;  // font associated with this listener

        public RadioButtonHandler(Font f){
            font = f; // font associated with this listener
        }
